// Alternate Version of GameLogic class that is logically the same, only stripped of JavaFX components to allow for testing.
public class GameLogicTest {
	public static boolean checkWin(GameButtonTest[][] buttons) {
	...
	public static String[] getPieces(GameButtonTest[][] buttons) {
